    ...
    public partial class AcademicoInfraDataContextAcademicoContext : DbMigration
    {
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        DisciplinaMatriculada_Id = c.Guid(),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.DisciplinaMatriculada", t => t.DisciplinaMatriculada_Id)
                .ForeignKey("dbo.DisciplinaMatriculada", t => t.DisciplinaAvaliadaId)
                .Index(t => t.DisciplinaAvaliadaId)
                .Index(t => t.DisciplinaMatriculada_Id);
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.Usuario", t => t.Discente_Id)
